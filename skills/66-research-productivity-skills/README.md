...
This collection vendors 20 practical agent skills for everyday research work:
paper discovery, literature synthesis, browser automation, file conversion,
slide production, Chinese text cleanup, UI design, and skill/command authoring.
...
| Design and authoring | [`frontend-design`](frontend-design/SKILL.md), [`ui-ux-pro-max`](ui-ux-pro-max/SKILL.md), [`skill-creator`](skill-creator/SKILL.md), [`command-development`](command-development/SKILL.md), [`do-agent`](do-agent/SKILL.md) | Build polished interfaces, create or improve skills, define slash commands, or coordinate complex multi-agent tasks |
...
vendor some document-office skills with restrictive distribution terms; those
should be installed from their authorized source instead of copied into this
repository.
