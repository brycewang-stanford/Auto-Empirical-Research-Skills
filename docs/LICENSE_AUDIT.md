...
- License buckets: AGPL-3.0=1, Apache-2.0=1, CC-BY-NC-4.0 (non-commercial)=1, CC-BY-SA-4.0 (repository default)=4, MIT=34, MIT Non-Commercial=1, MIXED - check individual skill folders=1, UNKNOWN - check upstream=23
- Commercial-use buckets: allowed=35, restricted=2, share-alike=5, unknown=24
- Source-confidence buckets: curated-local=1, high=38, low=6, medium=17, unresolved=4
...
| [`65-zheng-siyao-empirical-research-skills`](../skills/65-zheng-siyao-empirical-research-skills/) | [source](https://github.com/zheng-siyao/ai4socialscience-skills) | high | UNKNOWN - check upstream | unknown | manual vendor snapshot |
| [`66-research-productivity-skills`](../skills/66-research-productivity-skills/) | UNKNOWN | curated-local | MIXED - check individual skill folders | unknown | manual curated snapshot |
