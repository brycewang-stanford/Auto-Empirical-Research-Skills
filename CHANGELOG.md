...
This project keeps the long narrative changelog in `README.md` and this concise release log for GitHub Releases.
...
- Fixed stale local README links for the StatsPAI and Python empirical-analysis skills.
- Normalized lowercase `skill.md` files to exact-case `SKILL.md` for Linux CI/runtime compatibility.

## 2026-05-31

- Repository renamed to Auto-Empirical Research Skills (AERS, 23K+ Skills).
- Added AER-skills as a vendored top-5 economics submission stack with weekly upstream sync.
- Expanded README and bilingual project positioning.
