...
**面向实证研究的专业级 Agent Skills 发行版。** 不是一份营销清单 —— 本仓库**自有并已编目 1,099 个 skill**，外加一套**数值基准 + 评测套件 + 安全审计 + CI** 把质量焊死，再叠加一张覆盖**生态 23,000+ skill / 119 个仓库**的精选地图。
...
| 它是什么 | 数量 | 事实来源 |
|---|---:|---|
| **本仓库自有**并已编目的 skill | **1,099** | [`catalog/skills.json`](catalog/skills.json) |
...
| **来源与许可** | 未声明来源、许可风险、1,099 个编目 skill 的卫生度漂移 | [`docs/LICENSE_AUDIT.md`](docs/LICENSE_AUDIT.md) · [`docs/SKILL_QUALITY.md`](docs/SKILL_QUALITY.md) |
...
| [Research Productivity Skills](skills/66-research-productivity-skills/) | 本地 | 20 | 研究生产力工具包：论文检索、开放全文查找、综述生成、五问论文拆解、联网/浏览器自动化、Markdown/Word 转换、Marp 幻灯片、中文格式清理、UI 设计与 skill/command 开发 |
...
- **2026-06** —— 新增 **Research Productivity Skills**（`skills/66`）：20 个实用 skill，覆盖论文发现、文献综述、浏览器自动化、格式转换、演示文稿、中文清理、UI 设计与 agent skill 编写。
